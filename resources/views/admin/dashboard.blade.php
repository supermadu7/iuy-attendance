...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">Welcome To Your Dashboard</h2>
                ...
                <table class="table m-b-0 transcations mt-2">
                    <tbody>
                        <tr>
                            <td class="wd-5p">
                                <div class="main-img-user avatar-md">
                                    <img alt="avatar" class="rounded-circle me-3" src="../assets/images/faces/5.jpg">
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="wd-5p">
                                <div class="main-img-user avatar-md">
                                    <img alt="avatar" class="rounded-circle me-3" src="../assets/images/faces/6.jpg">
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-middle ms-3">
                        ...
                        <tr>
                            <td class="wd-5p">
                                <div class="main-img-user avatar-md">
                                    <img alt="avatar" class="rounded-circle me-3" src="../assets/images/faces/7.jpg">
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-middle ms-3">
                        ...
                        <tr>
                            <td class="wd-5p">
                                <div class="main-img-user avatar-md">
                                    <img alt="avatar" class="rounded-circle me-3" src="../assets/images/faces/8.jpg">
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-middle ms-3">
                        ...
                        <tr>
                            <td class="wd-5p pb-0">
                                <div class="main-img-user avatar-md">
                                    <img alt="avatar" class="rounded-circle me-3" src="../assets/images/faces/4.jpg">
                                </div>
                            </td>
                            <td class="pb-0">
                                <div class="d-flex align-middle ms-3">
